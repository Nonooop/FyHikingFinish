package com.nopi.fyhiking.activities
...
import com.nopi.fyhiking.adapter.NoteAdapter
import com.nopi.fyhiking.database.NoteDatabase
import com.nopi.fyhiking.model.ModelNote
import com.nopi.fyhiking.utils.onClickItemListener
...
class NoteActivity : AppCompatActivity(), onClickItemListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fabCreateNote.setOnClickListener {
            startActivityForResult(Intent(this@NoteActivity, CreateNoteActivity::class.java), REQUEST_ADD)
        }
